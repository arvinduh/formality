...
fn test_editorconfig_sync_command_workflow() {
  ...
  assert!(ec_content.starts_with("# Auto-generated by formality. DO NOT EDIT."));
  ...
  fs::write(&ec_path, "# Auto-generated by formality. DO NOT EDIT.\nroot = false\n").unwrap();
...
"#;
  ...
  let config = FormalityConfig::parse_str(toml_content, Path::new("formality.toml")).unwrap();
  let surfaces = all_surfaces();
