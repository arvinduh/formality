...
fn test_sync_config_workflow() {
  ...
  assert!(rustfmt_content.contains("WARNING: DO NOT EDIT THIS FILE DIRECTLY!"));
  ...
  assert!(ruff_content.contains("WARNING: DO NOT EDIT THIS FILE DIRECTLY!"));
  ...
  assert!(clang_content.contains("WARNING: DO NOT EDIT THIS FILE DIRECTLY!"));
