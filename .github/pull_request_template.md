...
- [ ] `feat`: New feature or surface capability
- [ ] `fix`: Bug fix
...
- [ ] `cargo test` (full suite, matches CI — `--lib` alone skips `tests/`)
      passed clean
...
Any specific areas of focus, architecture decisions, or context reviewers should be aware of.
