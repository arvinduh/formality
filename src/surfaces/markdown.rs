...
impl PrettierConfig {
  pub fn from_context(ctx: &ExecutionContext) -> Self {
    ...
    Self {
      comment: "WARNING: DO NOT EDIT THIS FILE DIRECTLY! Automatically generated and managed by formality (fml). Canonical source of truth: formality.toml. Run 'fml sync' to update.".to_string(),
